// src/main.js
/**
 * Main entry point for InnovativeCryptoCore application
 */
...
class InnovativeCryptoCore {
    /**
     * Create a new InnovativeCryptoCore instance
...
module.exports = InnovativeCryptoCore;
...
if (require.main === module) {
    ...
    const app = new InnovativeCryptoCore({
        input: args.input,
        output: args.output,
